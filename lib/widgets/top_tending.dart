...
import 'package:devera_news_application/page/new_webview/news_detail_webview_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.pushNamed(context, NewsDetailsPage.routeName,
                 arguments: {
                "isTrending": true,
